...
<head>
    ...
    <!-- ION ICONS -->
    <link type="text/css" rel="stylesheet" href="/vendors/fonts/ionicons.min.css">    
                        ...
                        <li class="dropdown"><a href="#" class="nav-link">Le Groupe <i class="ion-android-arrow-dropdown"></i></a>
                            <div class="dropdown-list">
                                <ul id="zero" class="dropdown-content">
                                    ...
                                    <li class="dropdown-item dropdown-li"><a href="#fondateurs" class="dropdown-item dropdown-nav-link">Les Fondateurs</a></li>
                                    <li class="dropdown-item dropdown-nav-link "><a href="#vision" class="nav-link">Vision</a></li>
                                    <li class="dropdown-item dropdown-nav-link"><a href="#mission" class="nav-link">Mission</a></li>
                                    <li class="dropdown-item dropdown-nav-link"><a href="#valeurs" class="nav-link">Valeurs</a></li>
                                </ul>
                            </div>
                        </li>
                        <li  class="dropdown"><a href="../activites/index.html" class="nav-link">Activites <i class="ion-android-arrow-dropdown"></i></a>
                            <div class="dropdown-list"> 
                                <ul class="dropdown-content">
                                    <li class="dropdown-item"><a href="../activites/servirces/#presta-srvc" class="dropdown-nav-link">Prestation de services</a></li>
                                    <li class="dropdown-item"><a href="../activites/servirces/#hotel-et-trsm" class="dropdown-nav-link">Hotelerie &amp; Tourisme</a></li>
                                    <li class="dropdown-item"><a href="../activites/servirces/#trans-et-dist" class="nav-link">Transport &amp; Distribution</a></li>
                                    <li class="dropdown-item"><a href="../activites/servirces/#indus-com-et-ngc" class="nav-link">Industrie, Commerce &amp; Négoce</a></li>
                                    <li class="dropdown-item"><a href="../activites/servirces/#constructeur-et-gstimb" class="nav-link">Construction &amp; Gestion-Immobilière</a></li>
                                    <li class="dropdown-item"><a href="#" class="nav-link">Marketing, Spectacles &amp; Evènementiel</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="dropdown"><a href="../carrieres/index.html" class="nav-link">carriere <i class="ion-android-arrow-dropdown"></i></a>
                            <div class="dropdown-list">
                                <ul class="dropdown-content">
                                    <li class="dropdown-item"><a href="../carrieres/#travailler-pour-nous" class="dropdown-nav-link">Travailler Pour Nous</a></li>
                                    <li class="dropdown-item"><a href="../carrieres/#offre-demploi" class="nav-link">Offres D'emploi</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-title nav-item"><a href="../contact/index.html" class="nav-link">Contact</a>
                        </li>
                    </ul>
       ...
       <div class="side-bar-row">
            ...
            <aside class="side-bar">
                ...
                <ul class="service-wrapper">
                    <li><a href="../activites/servirces/#presta-srvc">Prestation de Services</a></li>
                    <li><a href="../activites/servirces/#hotel-et-trsm">Hotelerie et Tourisme</a></li>
                    <li><a href="../activites/servirces/#indus-com-et-ngc">Transport et Distribution</a></li>
                    <li><a href="../activites/servirces/#indus-com-et-ngc">Industrie, Commerce et Négoce</a></li>
                    <li><a href="../activites/servirces/#constructeur-et-gstimb">Construction et Gestion-Immobilière</a></li>
                    <li><a href="../activites/servirces/#mrktg-spcl-et-evntml">Marketing, Spectacles et Evènementiel</a></li>
                </ul>
            </aside>
       </div>
       
       <div class="row fondateur-row">
           <h2 id="fondateurs">Les Fondateurs</h2>
        ...
        <section class="goals">
                <div class="desc" >
                    <h2 id="vision" class="goals-title title">
                        Vision
                    </h2>
                    <p class="para">
                        Nous vision est de fournir les services et les produits de haut de gamme et du premier choix, afin de rendre nos client heureux et fiers de les avoir choisis. Pour ce faire, nous avons un regard croisé sur ce que le client peut imaginer et attendre d'un service ou d'un produit. D'oú l'inspiration de notre nom <br>Vision-X.       
                    </p>
                </div>
                <div class="desc" >
                    <h2 id="valeurs" class="goals-title title">
                        Valeurs
                    </h2>
                    <p class="para">
                        Nous voulons principale être le leader dans le secteurs d'activité que nous couvrons grace à notre engagement pour la qualité vis-à-vis de nos clients et de notre intégrité dans tous ce que nous faisons.     
                    </p>
                </div>
                
                <div class="desc" >
                    <h2 id="mission" class="goals-title title" >
                        Mission
                    </h2>
                    <p class="para">
                        Notre mission principale est de satisfaire vos besoins divers grâce à notre capacité d'adoption et de la maitrise de notre environnement. Nous nous donnons donc l'objectif d'offir les services et les produits qui maximisent le bien-être de nos clients.    
                    </p>
                </div>
        </section>
        ...
        <div id="contact" class="map-box">
            ...
            <div class="form-box" id="form">
                ...
                <form action="index.html" method="POST"  name="myForm" id="myForm"class="contact-form">
                    <div class="row">
                        <div class="col span-1-of-3 form-label">
                            <label for="name">Name</label>
                        </div>
                        <div class="col span-2-of-3 form-label">
